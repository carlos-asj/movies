...
export type StorageHash =
  StorageHashBase<'3f7ca026c91caf3247e4bf13c12568d05d9b32cb1a249c1f7725165f37d46323'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Movie: {
      ...
      readonly posterPath: CodecTypes['pg/text@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    readonly Movie: {
      ...
      readonly posterPath: CodecTypes['pg/text@1']['input'] | null;
...
export namespace Models {
  export type public_Movie = {
    ...
    posterPath: CodecTypes['pg/text@1']['output'] | null;
          ...
          readonly Movie: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly posterPath: { readonly column: 'posterPath' };
